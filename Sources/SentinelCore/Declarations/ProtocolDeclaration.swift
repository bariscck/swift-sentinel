...
public final class ProtocolDeclaration: NamedDeclaration, AttributesProviding, ModifiersProviding,
                                        InheritanceProviding, DeclarationsProviding,
                                        SourceCodeProviding, SyntaxNodeProviding, @unchecked Sendable {
    public typealias SyntaxNode = ProtocolDeclSyntax
    ...
    init(node: ProtocolDeclSyntax, parent: Declaration?, sourceCodeLocation: SourceCodeLocation) {
        self.node = node
