#!/bin/bash
B="https://raw.githubusercontent.com/perrystreetsoftware/Harmonize/main"
O="/private/tmp/claude-501/-Users-bariscicek-Desktop-Sentinel/3bcdd13c-15d1-43fa-80ab-104e5cb6900d/scratchpad/harmonize-sources.md"
mkdir -p "$(dirname "$O")"
echo "# Harmonize Source Files" > "$O"
echo "" >> "$O"
echo "Fetched from https://github.com/perrystreetsoftware/Harmonize" >> "$O"
echo "" >> "$O"
